...
public class AddWoodToFire : ActionBase<Transform>
{
    public float setWoodSpeed = 1.0f;
    ...
    */
    ...
    /*Function: OnUpdate()
        ...
        * 2 We remove wood from the inventory
        * 3 We add wood to the chimney
        * 4 We end the action on true
    */
    protected override void OnUpdate()
    {
        if (setWoodSpeed < Timer())
        {
            ownerSystem.agent.GetComponent<Inventory>().RemoveOneWood();
            instance.AddWood();
            EndAction(true);
        }
    }
